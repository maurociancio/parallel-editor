...
% TODO, hacer que la imagen aparezca cerca
	\begin{figure}[H]
		\begin{center}
	...
	A continuación se muestra un diagrama de Gannt (ver ).

% GANNT aca

	El Gannt no incluye el buffer agregado al final. Se planificaron 3hh/dia/recurso productivas y el Gannt fue armado siguiendo este valor. La jornada de cada día fue realizada con esa cantidad de horas.
