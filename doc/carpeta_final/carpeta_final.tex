...
\begin{abstract}
En el presente trabajo se pretende encontrar y mostrar una solución a el problema de
...
Se desarrolló un producto que permite la edición simultánea de uno o más documentos asegurando
que no existe divergencia entre las partes aún si la conexión entre ellos posee alta latencia. A su vez,
