...
El código fuente de este proyecto se encuentra liberado bajo la licencia GPL v3 \cite{gpl} y puede ser encontrado
en el repositorio de GitHub \cite{github}.

\subsection{\texttt{RemoteMessages.scala}} \input{remoteMessages.tex}
\subsection{\texttt{ClientMessages.scala}} \input{clientMessages.tex}
\subsection{\texttt{DocumentMessages.scala}} \input{documentMessages.tex}
\subsection{\texttt{SocketNetworkConnection.scala}} \input{socketNetworkConnection.tex}
\subsection{\texttt{JupiterSynchronizer.scala}} \input{jupiterSynchronizer.tex}
\subsection{\texttt{BasicXFormStrategy}} \input{basicXFormStrategy.tex}
\subsection{\texttt{DocumentData}} \input{documentData.tex}
